...
public class SubwayService {
    ...
    private Map<Integer, Map<String, Integer>> stationTravelTime;
    ...
    public List<String> findRoute(int subwayCode, String start, String end) {
        return findRoute(networks.get(subwayCode), start, end);
    }

    // BFS를 사용해 출발역부터 도착역까지 최단 경로 찾기
    private static List<String> findRoute(Map<String, List<String>> network, String start, String end) {
    ...
    public int calculateTravelTime(List<String> route, String direction,int subwayCode) {
        ...
        Map<String, Integer> travelTimeMap = stationTravelTime.get(subwayCode);
