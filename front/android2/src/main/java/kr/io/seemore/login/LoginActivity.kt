...
import kr.io.seemore.MainActivity
import kr.io.seemore.databinding.ActivityLoginBinding
import kr.io.seemore.login.data.UserRequest
import kr.io.seemore.login.processor.UserProcessor
...
//        val csrfToken = Base64.getUrlEncoder().withoutPadding().encodeToString(csrfBytes)
        ...
        try {
            val customTabsIntent = CustomTabsIntent.Builder()
                ...
                .setToolbarColor(ContextCompat.getColor(this, kr.io.seemore.R.color.iotColor)) // 툴바 색상 설정 (예시 색상, 프로젝트에 맞게 변경)
                .build()
