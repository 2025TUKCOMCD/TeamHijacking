...
import com.example.front.databinding.ActivityAudioSignalMuchineBlecontrolBinding

class AudioSignalMuchineBLEControl : AppCompatActivity() {//전송할 데이터를 기능에 따라 변수 이름 지정
    ...
    private lateinit var binding: ActivityAudioSignalMuchineBlecontrolBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityAudioSignalMuchineBlecontrolBinding.inflate(layoutInflater)
